...
We recommend integration of our binary into your Xcode project to setup HockeySDK for your OS X app. You can also use our interactive SDK integration wizard in <a href="https://hockeyapp.net/mac/">HockeyApp for Mac</a> which covers all the steps from below. For other ways to setup the SDK, see [Advanced Setup](#advancedsetup).
...
1. Download the latest [HockeySDK-Mac](https://www.hockeyapp.net/releases/) framework which is provided as a zip-File.
